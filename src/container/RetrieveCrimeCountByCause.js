...
async function RetrieveCrimeCountByCause(district, crimeType) {
  try {
    ...
    const querySpec = {
      query: `SELECT VALUE COUNT(1) FROM c WHERE c.District = @district AND c["Cause - Primary"] = @crimetype`,
      parameters: [
        {
          name: "@district",
          value: district,
...
export default RetrieveCrimeCountByCause;
